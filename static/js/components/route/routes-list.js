export const routes = [
   ...
   },
   {
      ...
      "train_type": "suburban",
      "has_arrival_time": false,
      "description_en": "This line suspends operation during the winter period. Its launch in spring depends on weather conditions, and it is not possible to predict an exact date. It usually happens in March.",
      "description_ru": "Эта линия прекращает свою работу в зимний период. Запуск весной зависит от погодных условий и предсказать точную дату невозможно. Обычно это происходит в марте.",
      "description_ka": "ეს ხაზი ზამთრის პერიოდში მუშაობას წყვეტს. გაზაფხულზე მისი ამოქმედება დამოკიდებულია ამინდის პირობებზე და ზუსტი თარიღის წინასწარ განსაზღვრა შეუძლებელია. ჩვეულებრივ ეს მარტში ხდება.",
      "stations": [
         {
            "code": "kutaisi1",
            "role": "start",
